...
```json
{
  "step": "load | analyze | generate | execute",
...
data: { "step": "analyze", "status": "streaming", "delta": "首先" }
data: { "step": "analyze", "status": "streaming", "delta": "，我们需要" }
data: { "step": "analyze", "status": "done", "output": { "content": "完整分析内容" } }

data: { "step": "generate", "status": "running" }
data: { "step": "generate", "status": "done", "output": { "operations": [...] } }

data: { "step": "execute", "status": "running" }
data: { "step": "execute", "status": "done", "output": { "formulas": [...], "output_file": "result.xlsx" } }
...
data: { "step": "analyze", "status": "running" }
data: { "step": "analyze", "status": "streaming", "delta": "根据需求..." }
data: { "step": "analyze", "status": "done", "output": { "content": "完整分析" } }
