...
Revision ID: 219e20ee3b9c
Revises: 
Create Date: 2026-01-27 17:47:00.735694
...
def upgrade() -> None:
    ...
    sa.Column('operations_json', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    sa.Column('new_columns', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('formulas', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
